...
public class FERPlusEmotionNetwork extends ClassificationNetwork<ClassificationResult> {
    ...
    public FERPlusEmotionNetwork(Path modelPath) {
        ...
        this.setClassNames("neutral", "happiness", "surprise", "sadness", "anger", "disgust", "fear", "contempt");
    }
    ...
    public ClassificationResult run(Mat frame) {
        ...
        for (int i = 0; i < out.cols(); i++) {
            ...
            System.out.println("# " + getClassNameOrId(i) + ": " + probability + "%");
